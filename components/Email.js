  ...
  const connectEmail = async () => {
    ...
    try {
      const response = await fetch('/api/attach-support-email', {
        ...
        body: JSON.stringify({ email: supportEmail, password: supportPwd, server: imapServer }),
      });
          ...
          <div className="generation_header">
            ...
            { org && org.support_email?
              <div className="techwave_fn_user_profile">
                <button onClick={disconnectEmail}  className="techwave_fn_button" ><span>Disconnect Email</span></button>
                <br/>
                ...
                <form>
                  ...
                  <br/>
                  <button className="techwave_fn_button" type="button" aria-readonly={loading} onClick={() => connectEmail()}>
                    <span>Connect Support Email {loading && <FontAwesomeIcon icon={faSpinner} spin={true} />} {saved && <FontAwesomeIcon icon={faCheckCircle} />}</span>
                  </button>
                </form>
