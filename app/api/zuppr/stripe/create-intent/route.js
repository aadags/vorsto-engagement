...
export async function POST(req) {
  try {     
    const { items, amount, cartAmount, subCartAmount, subCartTaxAmount, deliveryAmount, tipAmount, dealCommissionAmount, currency, customerId, paymentMethodId, destinationAccountId, save } = await req.json();
